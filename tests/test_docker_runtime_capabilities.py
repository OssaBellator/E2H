...
@pytest.mark.parametrize(
    "version",
    ["1.3.6", "v1.3.6", "1.3.7", "1.3.6+vendor", "1.4.3", "1.4.9", "1.5.0", "1.5.1", "2.0.0"],
)
...
@pytest.mark.parametrize(
    "version",
    ["1.2.99", "1.3.5", "1.4.0", "1.4.2", "1.3.6-rc.1", "1.4.3-dev", "not-a-version"],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        json.dumps([{"Name": "runc", "Version": "1.3.6"}, {"Name": "runc", "Version": "1.3.7"}]),
    ],
)
